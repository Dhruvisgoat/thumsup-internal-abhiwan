...
//     const group = useRef();
//     const { scene, materials, animations, nodes } = useGLTF('/models/characters/Boy with all animations-transformed.glb');
...
//     return (
//         <>
//             <group ref={group} {...props} dispose={null} scale={[5, 5, 5]} position={[0, -6, 0]} >
//                 <group name="Scene">
//                     <group name="Armature003" >
//                         <primitive object={nodes.mixamorigHips} />
//                         <skinnedMesh name="model_0021" geometry={nodes.model_0021.geometry} material={materials['Material.038']} skeleton={nodes.model_0021.skeleton} />
...
export function Character2(props) {
    ...
    const { scene, animations } = useGLTF('/models/characters/BoyNew-transformed.glb')
            ...
            <group ref={group} {...props} dispose={null} scale={[10, 10, 10]} position={[0, -3.5, 0]} >
                ...
                <group name="Scene">
                    <group name="Armature003" rotation={[Math.PI / 2, 0, 0]} scale={0.01}>
                        <primitive object={nodes.mixamorigHips} />
                        <skinnedMesh ref={skinnedMeshRef} name="model_0023"
                            geometry={nodes.model_0023.geometry}
                            skeleton={nodes.model_0023.skeleton}
